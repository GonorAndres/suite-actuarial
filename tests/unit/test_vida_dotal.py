...
class TestVidaDotal:
    ...
    def test_calcular_prima_basica(self, config_dotal_20, tabla_simple, asegurado_basico):
    ...
    def test_prima_dotal_mayor_que_temporal(self, config_dotal_20, tabla_simple, asegurado_basico):
    ...
    def test_reserva_inicio_es_cero(self, config_dotal_20, tabla_simple, asegurado_basico):
    ...
    def test_reserva_final_es_suma_asegurada(self, config_dotal_20, tabla_simple, asegurado_basico):
    ...
    def test_prima_frecuencias_diferentes(self, config_dotal_20, tabla_simple, asegurado_basico):
    ...
    def test_pago_limitado_eleva_prima_anual(self, config_dotal_20, tabla_simple, asegurado_basico):
        """Financiar el mismo beneficio en menos anos eleva cada prima."""
        prima_10 = (
            VidaDotal(config_dotal_20, tabla_simple, plazo_pago=10)
            .calcular_prima(asegurado_basico)
            .prima_neta
        )
        prima_20 = (
            VidaDotal(config_dotal_20, tabla_simple, plazo_pago=20)
            .calcular_prima(asegurado_basico)
            .prima_neta
        )
