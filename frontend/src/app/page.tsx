...
const MODELS = {
  es: [
    ...
    ["¿Qué costo falta por desarrollarse?", "Reservas", "Chain Ladder, Bornhuetter-Ferguson, Bootstrap y Mack", "/reservas"],
  ...
  en: [
    ...
    ["Which cost remains undeveloped?", "Reserves", "Chain Ladder, Bornhuetter-Ferguson, Bootstrap, and Mack", "/reservas"],
